  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        {/* Footer Attribution */}
        <div className="flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-border/50 text-[10px] text-muted-foreground gap-2">
          <span>Created by Mahesh Arora</span>
